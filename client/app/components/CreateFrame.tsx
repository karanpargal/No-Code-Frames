...
const CreateFrame: React.FC<CreateFrameProps> = () => {
  ...
  return (
    <div className="flex items-center justify-center bg-gradient-to-b from-gray-900 via-pink-700 to-white h-screen w-screen">
      <div className="mb-3 w-96 p-8 flex flex-col gap-8 border border-gray-300 rounded-lg">
        <p className="mb-2 text-black font-bold text-xl">Create Frame</p>
        ...
        />
        <p className="text-black font-bold text-xl">Add suitable Frame Button</p>
        ...
        <button
          type="button"
          className="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-bold rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
        >
          Create Frame
        </button>
      </div>
