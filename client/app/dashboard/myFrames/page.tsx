...
export default function MyFrames() {
  ...
  return (
    <div className="bg-white h-screen p-8 text-black">
      <svg
      ...
      <h1 className="text-black text-center text-4xl mb-8">My Frames</h1>
      {loading ? (
          ...
          {frames.length > 0 ? (
            <div className="grid grid-cols-3 gap-4">
              {frames.map((frame: any) => (
                <div key={frame._id} className="bg-white rounded-sm shadow-md p-4 text-black border-black border-2">
                  <h2 className="text-xl font-semibold mb-2">Frame</h2>
                  <p className="">
                    Frame ID:{' '}
                    <span
                      className="flex gap-2 font-bold items-center cursor-pointer"
                      onClick={() => {
                        navigator.clipboard.writeText(frame._id);
                  ...
                  <p className="my-4 overflow-hidden mb-6">{frame.frame}</p>
                  ...
                  >
                    ...
                    <span className="relative text-black group-hover:text-white">View Frame</span>
                  </a>
                </div>
              ))}
            </div>
